...
const navItems = [
    ...
    { to: "/admin/interns", label: "Interns/Trainee", icon: <MdPerson size={18} /> },
    { to: "/admin/employee-applications", label: "Applications", icon: <MdPerson size={18} /> },
    { to: "/admin/events", label: "Announcement", icon: <MdCelebration size={20} /> },
