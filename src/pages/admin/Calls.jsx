...
const filteredCalls = (calls || []).filter((c) => {
  ...
  useEffect(() => {
  console.log("is_follow_up:", form.is_follow_up);
}, [form.is_follow_up]);
  ...
  if (checked) {
    ...
    console.log({
  follow: form.is_follow_up,
  transfer: form.transfer_to,
});
  };
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50">
                ...
                <th className="px-10 py-6 text-md font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">
                  Caller Info
                </th>
                <th className="px-8 py-6 text-md font-black text-slate-400 uppercase tracking-[0.2em]">
                  Employee
                </th>
                <th className="px-8 py-6 text-md font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">
                  Project
                </th>
                <th className="px-8 py-6 text-md font-black text-slate-400 uppercase tracking-[0.2em]">
                  Type
