...
const WorkLog = () => {
  ...
  return (
    <div className="space-y-8 px-5 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button
            variant="primary"
            className="shadow-lg shadow-[#132ea7]/20 py-3 px-8 rounded h-[52px] font-black uppercase tracking-widest text-sm flex items-center justify-center gap-2"
            onClick={openCreate}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div
          className={`p-8 rounded-[2rem] shadow-2xl flex items-center gap-6 text-white relative overflow-hidden transition-all duration-300 ${hasLoggedToday ? "bg-emerald-600 shadow-emerald-600/20" : "bg-[#132ea7] shadow-[#132ea7]/20"}`}
        >
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <SearchableSelect
                ...
                extraParams={{ all_dates: "true" }}
                value={form.task_id}
                selectedLabel={
                  selectedTask
                    ? `[${selectedTask.display_id}] ${selectedTask.task}`
                    : ""
                }
                onChange={(task) => {
                  ...
                  setForm((prev) => ({
                    ...prev,
                    task_id: task?.id || "",
                    project_id: task?.project_id || prev.project_id, // ← auto-fill project
                  }));
                  // also update selectedProject so the Project field shows correctly
                  if (task?.project) {
                    setSelectedProject(task.project);
                  }
                }}
                getLabel={(t) => `[${t.display_id}] ${t.task}`}
                placeholder="Search your tasks..."
                emptyOptionLabel="No Linked Task"
              />
            </div>
    ...
    />
          ...
          <div className="flex gap-4 pt-4 border-t border-slate-50">
            ...
            <Button
              type="submit"
              variant="primary"
              className="flex-[2] h-14 text-sm font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-[#132ea7]/20"
              loading={submitting}
            >
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-2xl font-black text-slate-800 leading-tight">
                    {viewTarget.User?.name || "Your Work Log"}
                  </h3>
    ...
    >
        ← {viewTarget.task.display_id} {viewTarget.task.task}
    </p>
)}
                  <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-xs mt-1">
              ...
              <div className="flex items-center gap-4 bg-slate-50 p-4 px-6 rounded-[1.5rem] border border-slate-100 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-base font-black text-slate-800 uppercase tracking-widest">
            ...
            <div className="p-10 bg-[#132ea7] rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                <p className="text-[11px] font-black text-white/50 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                  <MdOutlineSpeakerNotes size={20} className="text-white/30" />{" "}
                  Mission Activity Briefing
                </p>
